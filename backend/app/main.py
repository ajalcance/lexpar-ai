...
from app.api import auth, cases, courts, internal, livekit_token, scorecards, sessions
...
for module in (auth, cases, courts, sessions, scorecards, livekit_token, internal):
